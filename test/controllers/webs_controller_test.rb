...
class WebsControllerTest < ActionController::TestCase
  ...
  test "should create web" do
    assert_difference('Web.count') do
      post :create, web: { description: @web.description, private: @web.private, title: @web.title, user_id: @web.user_id }
    end
  ...
  test "should update web" do
    patch :update, id: @web, web: { description: @web.description, private: @web.private, title: @web.title, user_id: @web.user_id }
    assert_redirected_to web_path(assigns(:web))
  end
